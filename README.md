...
Course will contain the basics of HTML, CSS, ... and students will decide what else(potentially Ruby, Python, JS(AngularJS or React or Ember...))

We plan to decrease the amount of the lectures in favor of collective discussion, team projects & collective work.
...
5. CI/CD
6. ...
7. Since the course will be driven by students - you'll be able to decide here.
...
6. Finish [learngitbranching](http://learngitbranching.js.org) and put the screenshots of the completed task lists in the task_0 folder and add the links to  README.md file in the root of task_0 folder (you can read about markdown here: [writing-on-github](https://help.github.com/categories/writing-on-github/))
